...
class JWT_Manager:
    ...
    def __init__(self, secret, algorithm):
        ...
        with open('E:\\Studies\\Lyfter\\Repos\\Lyfter_DUAD\\Lyfter_DUAD\\module_2\\backend\\week_8_extra\\private_key.pem', 'rb') as f:
            self.private_key = f.read()
        with open('E:\\Studies\\Lyfter\\Repos\\Lyfter_DUAD\\Lyfter_DUAD\\module_2\\backend\\week_8_extra\\public_key.pem', 'rb') as f:
