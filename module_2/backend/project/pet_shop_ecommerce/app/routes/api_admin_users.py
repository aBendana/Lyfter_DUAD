...
from app.infrastructure.security.decorator_authenticator import admin_only
...
def update_cart_invoice(invoice_id):
    try:
        ...
        transactions.stock_logic(current_quantity, new_quantity, product_id, product_in_cart[0]["id"])
