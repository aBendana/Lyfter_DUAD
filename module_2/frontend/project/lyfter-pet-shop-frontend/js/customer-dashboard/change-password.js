...
import { validatePassword } from "./password-logic.js";
...
export async function changePassword() {
  try {
    ...
    const changePasswordContent = document.getElementById("dashboard-content");
    changePasswordContent.innerHTML = `<p class="error-message-generic">Failed to load change password form: ${error}. Please try again.</p>`;
  }
}
